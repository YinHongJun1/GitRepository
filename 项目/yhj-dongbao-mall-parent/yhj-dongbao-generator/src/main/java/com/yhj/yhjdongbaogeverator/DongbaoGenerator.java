package com.yhj.yhjdongbaogeverator;
...
public class DongbaoGenerator {
	...
	public static void main(String[] args) {
		...
		gc.setOutputDir("F:\\Yhj_CodePlay\\项目\\yhj-dongbao-mall-parent\\yhj-dongbao-service\\yhj-dongbao-ums\\src\\main\\java");
		gc.setAuthor("尹宏君");
		...
		dsc.setUrl("jdbc:mysql://192.168.0.104:2222/yhj-dongbao-mall_test?useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai");
		...
		pc.setParent("com.yhj.yhjdongbaoums");
		pc.setEntity("entity");
		pc.setMapper("mapper");
